...
In Google Cloud Console:
   gsutil cp gs://cloud-samples-data/ai-platform/sklearn/census_data/adult.data adult.data
   dl adult.data
"""
import datetime
import pandas
...
# categorical columns are columns that need to be 
# turned into a numerical value to be used by scikit-learn
CATEGORICAL_COLUMNS = (
    'workclass',
    'education',
    'marital-status',
...
with open('adult.data', 'r') as train_data:
    raw_training_data = pandas.read_csv(train_data, header=None, names=COLUMNS)
